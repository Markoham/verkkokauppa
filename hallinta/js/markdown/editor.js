jQuery(document).ready(function() {
  ...
  var showSource = function(content) {
    ...
    if (jQuery('#productdescriptionsource').get(0).value == markdown) {
      return;
    }
    jQuery('#productdescriptionsource').get(0).value = markdown;
  };
  ...
  jQuery('#productdescriptionsource').bind('keyup', function() {
